...
<script>
		...
		function secretPw(docId, sec, mapId) {
			var url = "${_ctx}/board/dialog/secretPw.ssol?docId="+docId + "&secretWritePw=" + sec + "&mapId=" + mapId;
...
<!-- 팝업띄우기 -->
	...
	<div id="wrap">
    	...
    	<div class="rightBlock">
            ...
            <!-- 검색 시작 -->
            <form id="frmsearch"  name="frmsearch" action="${_ctx}/board/doc/list.ssol" method="get" class="search_area">
                ...
                <table class="base_tbl">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a href="javascript:secretPw('${item.docId}', '${item.secretWritePw}', '${item.mapId}');" id="title">
