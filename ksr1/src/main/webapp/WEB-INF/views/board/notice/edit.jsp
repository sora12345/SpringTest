		...
		<div id="rightWrap">
			...
			<div class="rightBlock">
				...
				<div class="boardWrap">
					...
					<form id="frmWrite" name="frmWrite" action="${_ctx}/board/notice/edit.ssol" method="post" enctype="multipart/form-data">
						...
						<table class="base_tbl tbl_write">
							...
							<tr>
								...
								<td>
									<textarea name="boardContents" id="boardContents" required="required" style="font-family: sans-serif;">
