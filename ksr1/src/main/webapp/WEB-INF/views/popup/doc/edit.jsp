...
function addFile() {
	var appendingFileHtml = "<input type='file' name='files' style='width:90%' /> <img src=${_ctx}/res/images/button.jpg style='width:25px; cursor:pointer;' onclick='delFile(this)'/>";
		...
		<input type="hidden" id="popYn" value="${popupDTO.popupYn}"/>
			<div class="rightBlock">
				...
				<div class="boardWrap">
					...
					<form id="frmWrite" name="frmWrite" action="${_ctx}/popup/doc/edit.ssol" method="post" enctype="multipart/form-data">
						...
						<div class="btnSet alignCenter">
							...
							<a href="${_ctx}/popup/doc/list.ssol" class="disPB btnBase">취소</a>
						</div>
					</form>
				</div>
			</div>
